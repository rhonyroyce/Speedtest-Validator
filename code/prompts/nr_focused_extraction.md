...
Key labels: NR_PCI, NR_ARFCN, NR_BAND, NR_BW (→ nr_bandwidth_mhz for C1; if a second NR BW is visible → bandwidth_c2_mhz), NR5G_RSRP, NR5G_SINR, NR5G_RSRQ, NR_SB_Status, NR_Tx Pwr, NR_SCS, NR_DL Scheduling, NR_BLER, NR RX0-3 RSRP, NR_ANT MAX/MIN RSRP, ENDC Total Tx Pwr, NR_CDRX.
